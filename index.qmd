...
**Main question.** Within the 2017 Pedrógão Grande burn footprint, which 100-metre cells are most likely to reburn before the 2026 fire season?

Three sub-questions decompose the main question along three reburn driver mechanisms.

- **Q1. Ecological recovery.** Does the rate of post-fire vegetation recovery between 2018 and 2020 predict reburn probability?
- **Q2. Severity legacy.** Does the severity of the 2017 burn predict reburn probability?
- **Q3. Current fuel state.** Do 2025 vegetation cover, fuel moisture, and surface heat predict reburn probability?
